...
{
    public static class UnderbarrelShotgunVFX
    {
        ...
        {
            impactPrefab = CreateImpact(new Color32(234, 117, 23, 255), new Color32(211, 138, 23, 94), new Color32(255, 34, 0, 255));
            ghostPrefab = CreateGhost(new Color32(255, 82, 0, 255), new Color32(197, 115, 0, 255), new Color32(217, 120, 20, 255));
        }
        ...
        public static GameObject CreateImpact(Color32 hotPinkEquivalent, Color32 redEquivalent, Color32 spikeColor, float brighnessBoost = 11.08f, float alphaBoost = 4.3f)
        {
            ...
            var impact = Addressables.LoadAssetAsync<GameObject>("RoR2/DLC1/Railgunner/ImpactRailgunLight.prefab").WaitForCompletion().InstantiateClone("Underbarrel Shotgun Impact", false);
        ...
        public static GameObject CreateGhost(Color32 saturatedAquaEquivalent, Color32 saturatedBlueEquivalent, Color32 mutedAquaEquivalent)
        {
            ...
            var ghost = Addressables.LoadAssetAsync<GameObject>("RoR2/DLC1/LunarSun/LunarSunProjectileGhost.prefab").WaitForCompletion().InstantiateClone("Underbarrel Shotgun Ghost", false);
