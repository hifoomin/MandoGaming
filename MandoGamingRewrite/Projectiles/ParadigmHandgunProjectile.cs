...
{
    public static class ParadigmHandgunProjectile
    {
        public static GameObject prefab;

        public static void Init()
        {
            prefab = Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Mage/MageLightningBombProjectile.prefab").WaitForCompletion().InstantiateClone("Paradigm Handgun Slug", true);
            ...
            projectileSimple.lifetime = 1.5f;
            projectileSimple.desiredForwardSpeed = 250f;
            projectileSimple.enableVelocityOverLifetime = true;
            projectileSimple.velocityOverLifetime = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.08f, 0.75f), new Keyframe(0.1f, 1f));
